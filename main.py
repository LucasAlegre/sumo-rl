...
if __name__ == "__main__":
  ...
  cli.add_argument('-A', '--agent', choose=['fixed', 'ql'], default='ql', help="Selects agent type")
  cli.add_argument('-P', '--partition', choose=['mono', 'size', 'space'], default='mono', help="Selects partition type")
  cli.add_argument('-O', '--observation', choose=['default'], default='default', help="Select observation function")
  cli.add_argument('-R', '--reward', choose=['dwt', 'as', 'ql', 'p'], default='dwt', help="Select reward function")
